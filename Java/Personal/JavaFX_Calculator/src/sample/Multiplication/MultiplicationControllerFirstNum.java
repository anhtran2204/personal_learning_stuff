...
public class  MultiplicationControllerFirstNum {
    ...
    @FXML
    private TextField multiplicationTextField1;
    ...
    private void goToSecondScene() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/sample/Multiplication/MultiplicationSecondNum.fxml"));
            Stage stage = (Stage) OKButton.getScene().getWindow();
            Scene scene = new Scene(root, 350, 250);

            String num = multiplicationTextField1.getText();

...
//        todoListView.setItems(TodoData.getInstance().getTodoItems());
    ...
    public void handleKeyPressed(KeyEvent keyEvent) {
        ...
        if (selectedItem != null) {
            if (keyEvent.getCode().equals(KeyCode.DELETE)) {
                deleteTodoItemDialog(selectedItem);
            }
        }
    }
    ...
    public void showEditItemDialog() {
        ...
        editDialog.setTitle("Edit Todo Item");
        editDialog.setHeaderText("Use this dialog to edit a todo item");
        FXMLLoader fxmlLoader = new FXMLLoader();
        fxmlLoader.setLocation(getClass().getResource("todoItemDialog.fxml"));
        ...
        editController.adoptItem(selectedItem);

        Optional<ButtonType> result = editDialog.showAndWait();
        if (result.isPresent() && result.get() == ButtonType.OK) {
            editController.editItem(selectedItem);
    ...
    public void deleteTodoItemDialog(TodoItem item) {
